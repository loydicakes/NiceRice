...
class _AnalyticsPageState extends State<AnalyticsPage> {
      ...
      doc.addPage(
        pw.Page(
          build: (pw.Context c) => pw.Column(
            ...
            children: [
              pw.Text('NiceRice Session Report', style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
              ...
              pw.SizedBox(height: 20),
              pw.Text('Environment (If available)', style: pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold)),
              _pdfEnvStats(op, t),
              pw.Spacer(),
              pw.Divider(),
              pw.Text(
  ...
  pw.Widget _pdfInterpretationSection(OperationRecord op, AppLocalizations t) {
    ...
    return _pdfSection('Interpretation',
  ...
  pw.Widget _pdfDryingSpeedSection(OperationRecord op, AppLocalizations t) {
     ...
     return _pdfSection('Drying Speed', 
      child: pw.Table(
        columnWidths: const {0: pw.FlexColumnWidth(1), 1: pw.FlexColumnWidth(2)},
        children: [
          row('Start', DateFormat('MMM d, HH:mm:ss').format(op.startedAt)),
          row('End', op.endedAt == null ? '—' : DateFormat('MMM d, HH:mm:ss').format(op.endedAt!)),
