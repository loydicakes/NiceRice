...
// ⬇️ ADDED: localization + language controller
import 'language_controller.dart';        // uses ChangeNotifier + SharedPreferences
...
class _ProfilePanelState extends State<_ProfilePanel> {
  ...
  // Language selector (unchanged logic; now shown for both signed-in and logged-out)
    ...
    Widget chip(String label, String? code) {
      ...
      return ChoiceChip(
        ...
        onSelected: (v) async {
          if (!v) return;
          if (code == null) {
            await LanguageController.instance.setLocale(null); // System
          } else {
            ...
            child: Column(
              ...
              children: [
                ...
                if (signedIn) ...[
                  ...
                  // ⬇️ Language selector (signed-in)
                  _languageSelector(context),
                ],

                if (!signedIn) ...[
                  // ⬇️ Language selector (NOW ALSO when logged out / offline)
                  _languageSelector(context),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // ⬇️ Buttons aligned to the RIGHT
                Row(
